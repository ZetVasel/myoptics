...
@section('main')
	...
	{!! Form::open(['class' => 'features_add', 'action' => 'Admin\AdminFeaturesController@postAdd']) !!}
		<div class="col-sm-6">
			...
			<table class="table">
				...
				<tr>
					<td style="vertical-align: middle">
						<input name="check[]" value="{{ $post->id }}" type="checkbox"><a class="black_link" href="/master/option_variants/show/{{ $post->id }}">{{{ $post->name }}}</a>
					</td>
					<td style="text-align: right;">
						<div class="btn-group">
							<a title="Редактировать" href="/master/features/edit/{{ $post->id }}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>

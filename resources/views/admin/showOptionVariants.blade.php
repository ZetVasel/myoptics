...
@section('main')
	...
	<h1><a href="/master/features" class="glyphicon glyphicon-circle-arrow-left"></a>{{ $title }}</h1>

	@if(Session::has('message'))
		<div class="alert alert-success" role="alert">{{ Session::get('message') }}</div>
	@endif

	{!! Form::open(['class' => 'features_add', 'action' => 'Admin\AdminOptionVariantsController@postAdd' ]) !!}
		{!! Form::hidden('feature_id', $id) !!}
			...
			<table class="table">
				...
				<tr>
					...
					<td style="text-align: right;">
						<div class="btn-group">
							<a title="Редактировать" href="/master/option_variants/edit/{{ $post->id }}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>

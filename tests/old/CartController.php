...
class CartController extends BaseController
{
    ...
    public function getCartStepTwo(){
        ...
        $payment = Payment::all();
            // Тест по добавлению отделений новой почты -->
                $url = file_get_contents('https://novaposhta.ua/shop/office/getjsonwarehouselist');
            ...
            //Тест по добавлению отделений новой почты -->
        return view('frontend.showCartStepTwo', compact(['page', 'delivery', 'payment', 'warehouse_by_city']));
    ...
    public function postCartStepTwo(Request $request){
        ...
        return view('frontend.showCartStepThree', compact(['page', 'delivery', 'buy', 'deliveryInfo', 'addres', 'coment', 'city', 'phone', 'mail', 'name', 'cartProduct', 'countOrder', 'cart_info']));
    }
	...
	public function getCart(){
		...
		return view('frontend.showCart', compact(['cartProduct','page','cur_ids','delivery_methods','payment_method']));
	}
	...
	public function fullOrder( FullOrderRequest $request ){
		...
		$new_order = Orders::create( array_merge($insert, ['user_id' => $user_id], ['status' => 0], ['paid' => 0], ['delivery' => $request->get('delivery_method')], ['payment' => $request->get('payment_method')] ) );
